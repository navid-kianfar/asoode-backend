        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    StartFrame = table.Column<float>(type: "real", nullable: false),
                    EndFrame = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedTitle = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmbedCode = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    Text = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
                    ThumbImage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    MediumImage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    LargeImage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForUser = table.Column<Guid>(type: "uuid", nullable: true),
                    MaxUsage = table.Column<int>(type: "integer", nullable: false),
                    Percent = table.Column<int>(type: "integer", nullable: false),
                    MaxUnit = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PlanInfoId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarnAmount = table.Column<double>(type: "double precision", nullable: false),
                    Fixed = table.Column<int>(type: "integer", nullable: false),
                    MarketerId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentSize = table.Column<int>(type: "integer", nullable: false),
                    CanExtend = table.Column<bool>(type: "boolean", nullable: false),
                    PlanCost = table.Column<double>(type: "double precision", nullable: false),
                    TotalAmount = table.Column<double>(type: "double precision", nullable: false),
                    AppliedDiscount = table.Column<double>(type: "double precision", nullable: true),
                    ValueAdded = table.Column<double>(type: "double precision", nullable: false),
                    PaymentAmount = table.Column<double>(type: "double precision", nullable: false),
                    DiskSpace = table.Column<double>(type: "double precision", nullable: false),
                    Users = table.Column<int>(type: "integer", nullable: false),
                    WorkPackage = table.Column<int>(type: "integer", nullable: false),
                    Project = table.Column<int>(type: "integer", nullable: false),
                    SimpleGroup = table.Column<int>(type: "integer", nullable: false),
                    ComplexGroup = table.Column<int>(type: "integer", nullable: false),
                    AdditionalWorkPackageCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalUserCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalSpaceCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalProjectCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalSimpleGroupCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalComplexGroupCost = table.Column<int>(type: "integer", nullable: false),
                    FeatureCustomField = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeSpent = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeValue = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeOff = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureShift = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureReports = table.Column<bool>(type: "boolean", nullable: false),
                    FeaturePayments = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureChat = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureFiles = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureWbs = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureRoadMap = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTree = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureObjectives = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureSeasons = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureVote = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureSubTask = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureKartabl = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureCalendar = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureBlocking = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureRelated = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureComplexGroup = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureGroupTimeSpent = table.Column<bool>(type: "boolean", nullable: false),
                    UseWallet = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<int>(type: "integer", nullable: false),
                    AttachmentSize = table.Column<int>(type: "integer", nullable: false),
                    PlanCost = table.Column<int>(type: "integer", nullable: false),
                    CanExtend = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingCode = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ReferenceNumber = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ExternalId = table.Column<long>(type: "bigint", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalSimpleGroupCost = table.Column<int>(type: "integer", nullable: false),
                    AdditionalComplexGroupCost = table.Column<int>(type: "integer", nullable: false),
                    UsedUser = table.Column<int>(type: "integer", nullable: false),
                    UsedSpace = table.Column<long>(type: "bigint", nullable: false),
                    UsedProject = table.Column<int>(type: "integer", nullable: false),
                    UsedSimpleGroup = table.Column<int>(type: "integer", nullable: false),
                    UsedComplexGroup = table.Column<int>(type: "integer", nullable: false),
                    UsedWorkPackage = table.Column<int>(type: "integer", nullable: false),
                    FeatureCustomField = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeSpent = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeValue = table.Column<bool>(type: "boolean", nullable: false),
                    FeatureTimeOff = table.Column<bool>(type: "boolean", nullable: false),
