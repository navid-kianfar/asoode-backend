...
{
    private readonly string _socketQueueName;
    private readonly string _pushQueueName;
    ...
    )
    {
        ...
        _jsonBiz = jsonBiz;
        _queueBiz = queueBiz;
        _clientEndpoint = configuration["Setting:ClientEndpoint"]!;
        _socketQueueName = queueBiz.GetQueueName("socket", configuration["Setting:I18n:Default"]);
        _pushQueueName = queueBiz.GetQueueName("push", configuration["Setting:I18n:Default"]);
    }
    ...
    public async Task Enqueue(ActivityLogViewModel model)
    {
        try
        {
            using (var unit = _serviceProvider.GetService<ActivityDbContext>())
            {
                ...
                var notification = new NotificationViewModel { Url = _clientEndpoint, Type = model.Type };
                ...
                switch (model.Type)
                {
                    ...
                    case ActivityType.ChannelMessage:
                        ...
                        notification.Description =
                            GetDescription("PUSH_CHANNEL_TEXT_MESSAGE_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                await FindChannelTitle(unit, model.Conversation.ChannelId)
                            });
                        notification.Data = model.Conversation;
                        notification.Url = $"{_clientEndpoint}/messenger/{model.Conversation.ChannelId}";
                        notification.Users =
                    ...
                    case ActivityType.ChannelUpload:
                        ...
                        notification.Description =
                            GetDescription("PUSH_CHANNEL_UPLOAD_MESSAGE_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                await FindChannelTitle(unit, model.Conversation.ChannelId)
                            });
                    ...
                    case ActivityType.GroupAdd:
                        ...
                        notification.Url = $"{_clientEndpoint}/group/{model.Group.Id}";
                    ...
                    case ActivityType.GroupMemberPermission:
                        ...
                        if (model.GroupMember != null)
                        {
                            ...
                            notification.Url = $"{_clientEndpoint}/group/{model.GroupMember.GroupId}";
                        ...
                        else
                        {
                            ...
                            notification.Description =
                                GetDescription("PUSH_GROUP_MEMBER_PERMISSION_DESCRIPTION", new[]
                                {
                                    model.User.FullName,
                                    model.Pending.Identifier,
                                    await FindGroupTitle(unit, model.Pending.RecordId)
                                });
                            notification.Url = $"{_clientEndpoint}/group/{model.Pending.RecordId}";
                    ...
                    case ActivityType.GroupMemberAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_GROUP_MEMBER_ADD_DESCRIPTION", new[]
                            {
                    ...
                    case ActivityType.ProjectAdd:
                        ...
                        notification.Url = model.Project.Complex
                            ? $"{_clientEndpoint}/project/{projectId}"
                            : $"{_clientEndpoint}/work-package/{projectId}";
                        notification.Users = await FindProjectMembersIds(unit, model.UserId, model.Project.Id);
                        break;
                    case ActivityType.ProjectSubAdd:
                        ...
                        notification.Url = $"{_clientEndpoint}/project/{model.SubProject.ProjectId}";
                        notification.Users =
                    ...
                    case ActivityType.ProjectSeasonAdd:
                        ...
                        notification.Url = $"{_clientEndpoint}/project/{model.Season.ProjectId}";
                        notification.Users =
                    ...
                    case ActivityType.ProjectEdit:
                        ...
                        notification.Data = model.Project;
                        notification.Url = $"{_clientEndpoint}/project/{model.Project.Id}";
                        notification.Users = await FindProjectMembersIds(unit, model.UserId, model.Project.Id);
                    ...
                    case ActivityType.ProjectMemberRemove:
                        ...
                        if (model.ProjectMember != null)
                        {
                            ...
                            notification.Description =
                                GetDescription("PUSH_PROJECT_MEMBER_REMOVE_DESCRIPTION", new[]
                                {
                                    await FindProjectMemberName(unit, model.ProjectMember.RecordId),
                                    await FindProjectTitle(unit, model.ProjectMember.ProjectId),
                                    await FindUserFullName(unit, model.UserId)
                                });
                            notification.Url = $"{_clientEndpoint}/project/{model.ProjectMember.ProjectId}";
                        ...
                        else
                        {
                            ...
                            notification.Url = $"{_clientEndpoint}/project/{model.Pending.RecordId}";
                            notification.Data = model.Pending;
                            notification.Users =
                    ...
                    case ActivityType.WorkPackageUserSetting:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_USER_SETTING_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                        ...
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageUserSetting.PackageId}";
                        notification.Users = new[] { model.UserId };
                        break;
                    case ActivityType.WorkPackageFavorite:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_FAVORITE_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                    ...
                    case ActivityType.WorkPackageArchive:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_ARCHIVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.WorkPackage.Title
                            });
                    ...
                    case ActivityType.WorkPackageRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.WorkPackage.Title
                            });
                    ...
                    case ActivityType.WorkPackageLabelRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LABEL_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageLabel.Title
                            });
                        notification.Data = model.PackageLabel;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageLabel.PackageId}";
                        notification.Users =
                    ...
                    case ActivityType.WorkPackageLabelRename:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LABEL_RENAME_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageLabel.Title
                            });
                    ...
                    case ActivityType.WorkPackageLabelAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LABEL_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageLabel.Title
                            });
                    ...
                    case ActivityType.WorkPackageAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_ADD_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title
                            });
                        notification.Data = model.WorkPackage;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.WorkPackage.Id}";
                        notification.Users = await FindPackageMembersIds(unit, model.UserId, model.WorkPackage.Id);
                        break;
                    case ActivityType.WorkPackageEdit:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_EDIT_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title
                            });
                    ...
                    case ActivityType.WorkPackageRestore:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_RESTORE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.WorkPackage.Title
                            });
                    ...
                    case ActivityType.WorkPackageObjectiveAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_OBJECTIVE_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.Objective.Title
                            });
                        notification.Data = model.Objective;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.Objective.PackageId}";
                        notification.Users =
                    ...
                    case ActivityType.WorkPackageObjectiveEdit:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_OBJECTIVE_EDIT_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.Objective.Title
                            });
                    ...
                    case ActivityType.WorkPackageObjectiveRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_OBJECTIVE_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.Objective.Title
                            });
                    ...
                    case ActivityType.WorkPackageListAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                        notification.Data = model.PackageList;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageList.PackageId}";
                        notification.Users =
                    ...
                    case ActivityType.WorkPackageListEdit:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_EDIT_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageListOrder:
                        activity.RecordId = model.PackageList.PackageId;
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_ORDER_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageSetting:
                        activity.RecordId = model.WorkPackage.Id;
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_SETTING_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.WorkPackage.Title
                            });
                    ...
                    case ActivityType.WorkPackageMemberAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_MEMBER_ADD_DESCRIPTION", new[]
                            {
                    ...
                    case ActivityType.WorkPackageMemberPermission:
                        ...
                        if (model.WorkPackageMember != null)
                        {
                            ...
                            notification.Description =
                                GetDescription("PUSH_WORK_PACKAGE_MEMBER_PERMISSION_DESCRIPTION", new[]
                                {
                                    await FindUserFullName(unit, model.UserId),
                            ...
                            notification.Url = $"{_clientEndpoint}/work-package/{model.WorkPackageMember.PackageId}";
                        ...
                        else
                        {
                            ...
                            notification.Url = $"{_clientEndpoint}/work-package/{model.Pending.RecordId}";
                            notification.Data = model.Pending;
                            notification.Users =
                    ...
                    case ActivityType.WorkPackageMemberRemove:
                        ...
                        if (model.WorkPackageMember != null)
                        {
                            activity.RecordId = model.WorkPackageMember.PackageId;
                            notification.Description =
                                GetDescription("PUSH_WORK_PACKAGE_MEMBER_REMOVE_DESCRIPTION", new[]
                                {
                                    await FindUserFullName(unit, model.UserId),
                                    await FindProjectMemberName(unit, model.WorkPackageMember.RecordId),
                                    await FindPackageTitle(unit, model.WorkPackageMember.PackageId)
                    ...
                    case ActivityType.WorkPackageUpgrade:
                        activity.RecordId = model.WorkPackage.Id;
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_UPGRADE_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title
                            });
                        ...
                        notification.Data = model.WorkPackage;
                        notification.Url = $"{_clientEndpoint}/project/{model.WorkPackage.ProjectId}";
                        notification.Users = await FindPackageMembersIds(unit, model.UserId, model.WorkPackage.Id);
                        break;
                    case ActivityType.WorkPackageMerge:
                        activity.RecordId = model.WorkPackage.Id;
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_MERGE_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title,
                        ...
                        notification.Data = model.WorkPackage;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.WorkPackage2.Id}";
                        notification.Users = await FindPackageMembersIds(unit, model.UserId, model.WorkPackage.Id);
                        break;
                    case ActivityType.WorkPackageConnect:
                        activity.RecordId = model.WorkPackage.Id;
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_CONNECT_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title,
                                model.Project.Title
                    ...
                    case ActivityType.WorkPackageListArchive:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_ARCHIVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageListTasksArchive:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_ARCHIVE_TASKS_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageListTasksDelete:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_CLEAR_TASKS_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageListClone:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_LIST_CLONE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageList.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskVote:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_VOTE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                        notification.Data = model.PackageTaskVote;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageTaskVote.PackageId}";
                    ...
                    case ActivityType.WorkPackageTaskVoteReset:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_VOTE_RESET_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                        notification.Data = model.PackageTask.Id;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageTask.PackageId}";
                        notification.Users = await FindTaskMembersIds(
                            unit, model.UserId, model.PackageTask.PackageId, model.PackageTask.Id);
                        break;
                    case ActivityType.WorkPackageTaskTime:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_TIME_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskWatch:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_WATCH_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskBulkAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_BULK_ADD_DESCRIPTION", new[]
                            {
                                model.User.FullName,
                                model.WorkPackage.Title,
                    ...
                    case ActivityType.WorkPackageTaskArchive:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ARCHIVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskEdit:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_EDIT_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskDone:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_DONE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskUnBlock:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_UNBLOCK_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskPaused:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_STOP_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskComment:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_COMMENT_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                        notification.Data = model.PackageTaskComment;
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageTaskComment.PackageId}";
                        notification.Users = await FindTaskMembersIds(
                    ...
                    case ActivityType.WorkPackageTaskReposition:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_REPOSITION_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskMove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_MOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTask.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskLabelAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_LABEL_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageLabel.Title,
                                model.PackageTask.Title
                        ...
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageTaskLabel.PackageId}";
                        notification.Users = await FindTaskMembersIds(
                    ...
                    case ActivityType.WorkPackageTaskLabelRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_LABEL_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageLabel.Title,
                                model.PackageTask.Title
                    ...
                    case ActivityType.WorkPackageTaskAttachmentAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ATTACHMENT_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                        ...
                        notification.Url = $"{_clientEndpoint}/work-package/{model.PackageTaskAttachment.PackageId}";
                        notification.Users = await FindTaskMembersIds(
                    ...
                    case ActivityType.WorkPackageTaskAttachmentBulkAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ATTACHMENT_BULK_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                    ...
                    case ActivityType.WorkPackageTaskAttachmentRename:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ATTACHMENT_RENAME_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTaskAttachment.Title,
                                model.PackageTask.Title
                    ...
                    case ActivityType.WorkPackageTaskAttachmentRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ATTACHMENT_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTaskAttachment.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskAttachmentCover:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_ATTACHMENT_COVER_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                model.PackageTaskAttachment.Title
                            });
                    ...
                    case ActivityType.WorkPackageTaskMemberAdd:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_MEMBER_ADD_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                        ...
                        notification.Url = $"{_clientEndpoint}/work-package/{model.WorkPackageTaskMember.PackageId}";
                        notification.Users = await FindTaskMembersIds(
                    ...
                    case ActivityType.WorkPackageTaskMemberRemove:
                        ...
                        notification.Description =
                            GetDescription("PUSH_WORK_PACKAGE_TASK_MEMBER_REMOVE_DESCRIPTION", new[]
                            {
                                await FindUserFullName(unit, model.UserId),
                                await FindProjectMemberName(unit, model.WorkPackageTaskMember.RecordId),
                                model.PackageTask.Title
    ...
    private async Task QueueNotifications(NotificationViewModel notification)
    {
        try
        {
            if (notification.Users.Any())
            {
                ...
                await _queueBiz.Enqueue(_socketQueueName, socketData);
            }
            if (notification.PushUsers.Any())
            {
                ...
                await _queueBiz.Enqueue(_pushQueueName, pushData);
            }
        }
        catch (Exception e)
        {
    ...
    private string GetDescription(string key, string[] inputs)
    {
        return string.Format(_translateBiz.Get(key), inputs);
    }
