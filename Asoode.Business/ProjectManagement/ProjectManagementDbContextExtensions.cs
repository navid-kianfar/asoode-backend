...
public static class CollaborationDbContextExtensions
{
    ...
    public static async Task<Tuple<Group, UserPlanInfo>[]> FindGroupsWithPlans(this CollaborationDbContext unit,
        Guid userId)
    {
        var groups = await (
            from member in unit.GroupMembers
...
public static class ProjectManagementDbContextExtensions
{
    ...
    public static async Task<Tuple<Project, UserPlanInfo>[]> FindProjectsWithPlans(this ProjectManagementDbContext unit,
        Guid userId, Guid[] groupIds)
    {
        var result = (await (
    ...
    public static async Task<Guid[]> FindWorkPackageIds(this ProjectManagementDbContext unit, Guid userId,
        Guid[] groupIds)
    {
    ...
    public static async Task<WorkPackage[]> FindWorkPackages(this ProjectManagementDbContext unit, Guid userId,
        Guid[] groupIds)
    {
        var result = await (
    ...
    public static async Task<WorkPackage[]> FindProjectWorkPackages(this ProjectManagementDbContext unit, Guid userId,
        Guid projectId, Guid[] groupIds)
    {
        var result = await (
                from pkg in unit.WorkPackages
                join member in unit.WorkPackageMembers on pkg.Id equals member.PackageId
    ...
    public static async Task<ProjectMember[]> FindProjectPermissions(this ProjectManagementDbContext unit, Guid userId,
        Guid[] groupIds)
    {
        var result = await (
                from member in unit.ProjectMembers
    ...
    public static async Task<ProjectMember[]> FindProjectsMembers(this ProjectManagementDbContext unit,
        Guid[] projectIds)
    {
        var result = await (
                from member in unit.ProjectMembers
