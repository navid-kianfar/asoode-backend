...
public interface ITaskBiz
{
    ...
    Task<OperationResult<UploadResultViewModel>> AddAttachment(Guid userId, Guid taskId, StorageItemDto file);
    ...
    Task<OperationResult<UploadResultViewModel>> BulkAttachment(Guid userId, Guid id, StorageItemDto file);
